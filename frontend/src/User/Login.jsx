  ...
  <div className="w-full max-w-md">
    ...
    <div className="bg-white dark:bg-slate-800/60 backdrop-blur-sm border border-gray-200 dark:border-slate-700/50 rounded-2xl shadow-2xl px-8 py-10">
      ...
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-gray-500 dark:text-slate-400 text-sm">Welcome back! Please enter your details.</p>
      </div>
      ...
      <form onSubmit={loginSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full bg-gray-50 dark:bg-slate-900/70 border ${fieldErrors.email ? "border-red-500" : "border-gray-200 dark:border-slate-700"} ${fieldErrors.email ? "focus:border-red-500 focus:ring-red-500/20" : "focus:border-amber-500 focus:ring-amber-500/20"} focus:ring-2 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 rounded-xl pl-10 pr-4 py-3 text-sm outline-none transition-all duration-200`}
            />
          </div>
          {fieldErrors.email && (
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full bg-gray-50 dark:bg-slate-900/70 border ${fieldErrors.password ? "border-red-500" : "border-gray-200 dark:border-slate-700"} ${fieldErrors.password ? "focus:border-red-500 focus:ring-red-500/20" : "focus:border-amber-500 focus:ring-amber-500/20"} focus:ring-2 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 rounded-xl pl-10 pr-4 py-3 text-sm outline-none transition-all duration-200`}
            />
          </div>
        ...
        <div className="flex justify-end">
          <Link
            to="/forgot/password"
            className="text-xs text-amber-500 hover:text-amber-400 dark:hover:text-amber-300 font-semibold transition-colors duration-150"
          >
