...
export default function Dashboard() {
  ...
  <>
    ...
    <div className="mt-15 min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex">
      ...
      <aside className="w-60 shrink-0 bg-slate-900/80 border-r border-slate-700/50 flex flex-col min-h-screen">
        ...
        <div className="flex items-center gap-2 px-5 py-5 border-b border-slate-700/50">
          <DashboardIcon className="text-amber-400" style={{fontSize: 22}} />
        ...
        <nav className="flex flex-col gap-6 px-4 py-6 flex-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link to='/admin/products' className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-slate-300 hover:text-amber-400 hover:bg-amber-400/10 border border-transparent hover:border-amber-400/20 transition-all duration-200">
              <Inventory style={{fontSize: 16}} /> All Products
            </Link>
            <Link to='/admin/product/create' className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-slate-300 hover:text-amber-400 hover:bg-amber-400/10 border border-transparent hover:border-amber-400/20 transition-all duration-200">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link to='/admin/users' className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-slate-300 hover:text-amber-400 hover:bg-amber-400/10 border border-transparent hover:border-amber-400/20 transition-all duration-200">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link to='/admin/orders' className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-slate-300 hover:text-amber-400 hover:bg-amber-400/10 border border-transparent hover:border-amber-400/20 transition-all duration-200">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link to='/admin/reviews' className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-slate-300 hover:text-amber-400 hover:bg-amber-400/10 border border-transparent hover:border-amber-400/20 transition-all duration-200">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-5 flex flex-col gap-2">
              <Inventory className="text-amber-400" style={{fontSize: 22}} />
            ...
            <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-5 flex flex-col gap-2">
              <ShoppingCart className="text-amber-400" style={{fontSize: 22}} />
            ...
            <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-5 flex flex-col gap-2">
              <Star className="text-amber-400" style={{fontSize: 22}} />
            ...
            <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-5 flex flex-col gap-2">
              <CurrencyRupee className="text-amber-400" style={{fontSize: 22}} />
